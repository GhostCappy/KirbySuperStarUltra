 ...
 ***
## Learning Assembly
- Starcube Lab's tutorial on reverse engineering DS games: (https://www.starcubelabs.com/reverse-engineering-ds/)
...
- .tierith (AKA Harrison), for providing resources and giving advice on how to start finding important memory addresses. Also the developer for Kirby and the Amazing Mirror Archipelago.
