...
treasures: Dict[str, ItemData] = {
    ...
    item_names.screw_attack: ItemData(BASE_ID + 0x207, ItemClassification.progression, 80000),
    item_names.echigo_candy: ItemData(BASE_ID + 0x208, ItemClassification.progression, 8000),
    item_names.phanto_mask: ItemData(BASE_ID + 0x209, ItemClassification.progression, 278000),
    ...
    item_names.seasons_heart: ItemData(BASE_ID + 0x20D, ItemClassification.progression, 250000),
    ...
    item_names.machine_parts: ItemData(BASE_ID + 0x216, ItemClassification.progression, 55480),
    item_names.bucket: ItemData(BASE_ID + 0x217, ItemClassification.progression, 200),
    item_names.power_paintbrush: ItemData(BASE_ID + 0x218, ItemClassification.progression, 250000),
    ...
    item_names.cell_phone: ItemData(BASE_ID + 0x21C, ItemClassification.progression, 30),
    ...
    item_names.koopa_shell: ItemData(BASE_ID + 0x21F, ItemClassification.progression, 800),
    ...
    item_names.three_star_cane: ItemData(BASE_ID + 0x223, ItemClassification.progression, 250000),
    item_names.broken_bowl: ItemData(BASE_ID + 0x224, ItemClassification.progression, 50),
    ...
    item_names.gold_watering_can: ItemData(BASE_ID + 0x22E, ItemClassification.progression, 250000),
    ...
    item_names.kongs_barrel: ItemData(BASE_ID + 0x232, ItemClassification.progression, 1500),
    item_names.ramias_scale: ItemData(BASE_ID + 0x233, ItemClassification.progression, 12800),
...
planets: Dict[str, ItemData] = {
    ...
    item_names.aquarius: ItemData(BASE_ID + 0x401, ItemClassification.progression),
    item_names.skyhigh: ItemData(BASE_ID + 0x402, ItemClassification.progression),
    item_names.hotbeat: ItemData(BASE_ID + 0x403, ItemClassification.progression),
    item_names.cavius: ItemData(BASE_ID + 0x404, ItemClassification.progression),
    item_names.mekkai: ItemData(BASE_ID + 0x405, ItemClassification.progression),
